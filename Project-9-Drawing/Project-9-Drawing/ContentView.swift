...
//  Project-9-Drawing
//
//  Created by Pawel Baranski on 16/01/2023.
//
...
struct ContentView: View {
    ...
    var body: some View {
        Form{
            ColorRectangleCircle(amount: colorRectangle).frame(width: 300, height: 300)
...
struct ColorRectangleCircle: View {
    var amount = 0.0
    var steps = 100
